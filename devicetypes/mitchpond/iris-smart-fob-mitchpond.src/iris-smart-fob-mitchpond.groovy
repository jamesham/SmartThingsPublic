 ...
 */
metadata {
	definition (name: "Iris Smart Fob (mitchpond)", namespace: "mitchpond", author: "Mitch Pond") {
		capability "Battery"
		capability "Button"
	...
	tiles(scale: 2) {
    	standardTile("presence", "device.presence", width: 6, height: 4, canChangeBackground: true) {
