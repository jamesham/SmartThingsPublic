 ...
 *
 *  4/10/2016 - motley74 Added fingerprint for NYCE Door Hinge Sensor
 *
 */
 
metadata {
	definition (name: "NYCE Open/Closed Sensor (includes hinge)", namespace: "smartthings", author: "NYCE") {
    	capability "Battery"
