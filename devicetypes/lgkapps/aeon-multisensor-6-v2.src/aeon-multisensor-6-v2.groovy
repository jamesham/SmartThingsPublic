	...
	tiles(scale: 2) {
		...
		valueTile("humidity", "device.humidity", inactiveLabel: false, width: 2, height: 2) {
			state "humidity", label:'Humidity\n${currentValue}%', unit:"",icon: "http://cdn.device-icons.smartthings.com/Weather/weather12-icn@2x.png",
              backgroundColors : [
                    [value: 01, color: "#09f500"],
                    [value: 15, color: "#32cd00"],
                    [value: 30, color: "#629c00"],
                    [value: 45, color: "#877700"],
                    [value: 60, color: "#aa5400"],
                    [value: 75, color: "#d02e00"],
                    [value: 90, color: "#fb0400"]
         ]        
		}
		...
		valueTile("illuminance", "device.illuminance", inactiveLabel: false, width: 2, height: 2) {
			state "illuminance", label:'${currentValue} ${unit}', unit:"lux", backgroundColors:[
                    ...
                    [value: 3, color: "#545454"],
                    [value: 12, color: "#666666"],
					[value: 24, color: "#787878"],
					[value: 36, color: "#939393"],
					[value: 128, color: "#b1b1b1"],
                    [value: 1000, color: "#c7c7c7"],
                    [value: 1500, color: "#e0e0e0"],
		...
		valueTile("ultravioletIndex", "device.ultravioletIndex", inactiveLabel: false, width: 2, height: 2) {
			state "ultravioletIndex", label:'${currentValue} UV index', unit:"", backgroundColors:[
                    ...
                    [value: 3, color: "#ffaeae"],
                    [value: 6, color: "#ff9c9c"],
                    [value: 9, color: "#ff7878"],
					[value: 12, color: "#ff3c3c"]
               ]
		}
		...
		valueTile("battery", "device.battery", inactiveLabel: false, width: 2, height: 2) {
			state "battery", label:'${currentValue}% battery', unit:"",
             backgroundColors : [
                    [value: 15, color: "#f80700"],
                    [value: 25, color: "#de2100"],
                    [value: 35, color: "#c73700"],
                    [value: 45, color: "#a65900"],
                    [value: 55, color: "#8a7400"],
                    [value: 65, color: "#5ea100"],
                    [value: 75, color: "#35c900"],
                    [value: 85, color: "#19e600"],
                    [value: 95, color: "#01fd00"]
             ]
		}
